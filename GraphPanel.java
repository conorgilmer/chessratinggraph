/*
 * Line Graph of my Rating over the years using Java
 * 
 */
...
//    }
    ...
    private static void createAndShowGui() {
        ...
        int maxDataPoints = ratings.length;
        int maxScore = 10;
        for (int i = 0; i < maxDataPoints; i++) {
		//add scores from an array here rather than the random number
            scores.add((double) ratings[i]);
            //scores.add((double) random.nextDouble() * maxScore);
//            scores.add((double) i);
        }
        GraphPanel mainPanel = new GraphPanel(scores);
        mainPanel.setPreferredSize(new Dimension(800, 600));
        JFrame frame = new JFrame("My Rating");
